    ...
    <>
      <footer>
        <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
          {/* Top area: Blocks */}
          <div className=" footer grid sm:grid-cols-12 gap-5 py-8 md:py-12 border-t border-gray-200 lg:ml-0">
            {/* 1st block */}
            <div className="col-span-12 lg:col-span-3">
              <div
                style={{ width: "201px", alignItems: "center" }}
            ...
            {/* 2nd block */}
            <div className="col-span-3 md:col-span-6 lg:col-span-1 ml-7 mx-auto">
           ...
           <div className="col-span-5 md:col-span-6 lg:col-span-2 mx-auto">
            ...
            {/* 4th block */}
            <div className="col-span-12 lg:col-span-3 mx-auto text-center font-bold uppercase text-black">
