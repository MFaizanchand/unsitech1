...
import PHP from '../../images/ui ux 1.png'
import PHP2 from '../../images/ui ux 2.png'
import PHP3 from '../../images/ui ux 3.png'
          ...
          <Container fluid style={{ padding: '0' }}>
            ...
            >
              <Col style={{ color: 'white', textAlign: 'left', padding: '20px' }}>
                <h1>HIRE A UI UX DESIGNER</h1>
                <p>
                  Get the full spectrum of PHP Development Lifecycle, from Codebase
                  Assessment and maintenance to crafting innovation platforms from scratch.
                </p>
              </Col>
            </Row>
            ...
            <Row className='data-section' data-aos='fade-right' style={{ margin: '0' , paddingTop:'125px' }}>
              <Col style={{ paddingTop: '125px', padding: '20px' }}>
                <img src={PHP} alt='PHP Logo' style={{ width: '100%', height: 'auto' }} />
              </Col>
              <Col style={{ paddingTop: '125px', padding: '20px' }}>
                <h1 style={{ textAlign: 'center', fontSize: '1.5rem' }}>Our site of PHP</h1>
                <p>
                </p>
              </Col>
            </Row>
            ...
            <Row data-aos='fade-right' style={{ margin: '0', padding: '20px' }}>
              ...
              <Col style={{ margin: '55px', padding: '20px' }}>
                <h1 style={{ textAlign: 'left', fontSize: '1.5rem' }}>Our site of PHP</h1>
                <p>
                  Searching for a powerful web app that provides a lightning-fast user experience?
                  PHP is designed to do exactly that! Explore the growing range of bespoke PHP web
                  development services at UNSI that aspire to enable every business with a custom-built website.
                </p>
                
    
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '75px' }}>
                  <div style={{ flex: '1', marginRight: '20px' }}>
                    <h1 style={{ textAlign: 'left', fontSize: '1rem' }}>Custom Web Apps</h1>
                    <p>
                      Harness PHP open-source capabilities and Extensive Libraries to Craft unique web apps.
                    </p>
                  </div>
            ...
            <Row data-aos='fade-left' style={{ margin: '0', padding: '20px' }}>
              <Col style={{ margin: '55px', padding: '20px' }}>
                ...
                <p>
                  Experience the power of web application with UNSI. We create websites with the
                  latest industry standards in record time, supported by our round-the-clock customer
                  service for all technical needs.
                </p>
            ...
            <div className="container-fluid" style={{ padding: '0' }}>
              <Row className="justify-content-center text-center my-5" style={{ margin: '0' }}>
                <Col xs={12} md={8} lg={6}>
                  ...
                  <p>
                    We have Tailored PHP Solutions to match your unique needs. Whether it's a full project team, dedicated PHP developers, or ongoing support, UNSI lets you decide what's best for your success.
                  </p>
                </Col>
              </Row>
    
              <Row data-aos="fade-down" className="align-items-center" style={{ margin: '0', padding: '20px' }}>
                ...
                <Col xs={12} md={6} lg={8}>
                  ...
                  <p>
                    Progressively faster enterprise-wide systems whereas equity invested web-readiness harness installed base bandwidth.
                  </p>
